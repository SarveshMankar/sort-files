...
Photos=['.png','.jpeg','.jpg','.tiff','.jfif']
Programming=['.css','.py','.java','.php','.html','.c','.cpp','.ipynb','.less','.asm' ,'.json','.joblib','.js','.asm']
