...
for i in lst:
	b=i.split('.')
	extensions.append(str('.')+str(b[int(len(b))-1]))
...
if '.png' or '.jpeg' or '.jpg' or '.tiff' in extensions:
	try:
		...
		pass
if '.css' or '.py' or '.java' or '.php' or '.html' or '.c' or '.cpp' or '.ipynb' or '.less' or '.asm' or '.ASM' or '.json' or '.joblib' in extensions:
	try:
...
if '.odt' or '.docx' or '.doc' or '.txt' or '.pdf' or '.wpd' or '.rtf' or '.ods' or '.odp' or '.ppt' or '.pptx' or '.url' in extensions:
	try:
		...
		pass
if '.mp3' or '.WMA' or '.AAC' or '.WAV' or '.FLAC' or '.ram' or '.wma' or '.mpa' or '.ra' in extensions:
	try:
		os.mkdir("Music")
	except:
		pass
...
for i in lst:
	...
	if i[-4:]=='.csv' or i[-3:]=='.db' or i[-5:]=='.psql' or i[-5:]=='.data' or i[-5:]=='.xlsx':
		try:
			...
			pass
	#Programs
	if i[-4:]=='.css' or i[-3:]=='.py' or i[-5:]=='.java' or i[-4:]=='.php' or i[-5:]=='.html' or i[-2:]=='.c' or i[-4:]=='.cpp' or i[-6:]=='.ipynb' or i[-5:]=='.less' or i[-4:]=='.asm' or i[-4:]=='.ASM' or i[-5:]=='.json' or i[-7:]=='.joblib':
		try:
	...
	if i[-4:]=='.mp4' or i[-4:]=='.gif' or i[-5:]=='.webm' or i[-4:]=='.m4p' or i[-4:]=='.mp2' or i[-4:]=='.mov':
		try:
			...
			pass
	#Music
	if i[-4:]=='.mp3' or i[-4:]=='.WMA' or i[-4:]=='.ACC' or i[-4:]=='.WAV' or i[-4:]=='.wav' or i[-5:]=='.FLAC' or i[-4:]=='.ram' or i[-4:]=='.mpa' or i[-4:]=='.wma' or i[-3:]=='.ra':
		try:
